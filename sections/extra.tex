...
\begin{table*}
  ...
  \begin{tabular}{lcccc|cccc}
    ...
    & \multicolumn{2}{c}{$\fnl$=0} & \multicolumn{2}{c}{$\fnl$=76.9} & \multicolumn{2}{c}{$\fnl$=0} & \multicolumn{2}{c}{$\fnl$=76.9} \\
    & $\chi^{2}$ & $p$-value & $\chi^{2}$ & $p$-value & $\chi^{2}$ & $p$-value & $\chi^{2}$ & $p$-value \\
    \hline
No Weight & 679.8 & < 0.001 & 20014.8 & < 0.001 & 405.2 & < 0.001 & 721.1 & < 0.001 \\
Nonlinear Three Maps & 119.5 & 0.002 & 118.6 & 0.273 & 109.7 & 0.003 & 38.0 & 0.951 \\
Nonlinear Four Maps & 118.2 & 0.001 & 124.6 & 0.240 & 115.9 & 0.001 & 43.3 & 0.921 \\
Nonlinear Nine Maps & 71.9 & 0.487 & 195.1 & 0.047 & 74.9 & 0.392 & 62.2 & 0.767 \\
    \hline
  \end{tabular}
\end{table*}
...
\begin{table}
  \caption{Mean density and cross power spectrum $\chi^{2}$ and $p$-values that are inferred from the comparison to the $\fnl=0$ clean mocks \mr{that have had no mitigation applied to them}. \mc{remake this table by comparing the chi2 to the mock chi2 distribution that have had the same treatment, similar to Figure A4. Use this table in the main text and make sure we discuss the fNL dependence in Appendix.}}\label{tab:chi2test}
  \begin{tabular}{lcccc}
    \hline
    \hline
