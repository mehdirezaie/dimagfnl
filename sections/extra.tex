...
\begin{table*}
  %\begin{center}
    \caption{Best fit and marginalized estimates for $\fnl$ from fitting the mean power spectrum of the mocks before and after corrections using the nonlinear approach with various combinations of the imaging systematic maps. The estimates are not accounted for over correction, and therefore are subject to mitigation systematics.}   
...
\begin{figure*}
    ...
    \caption{The mean power spectrum of the $\fnl =0$ and $76.9$ mocks with (dashed) and without (solid) imaging systematics before and after applying the nonlinear cleaning method with three, four, and nine maps.}
\end{figure*}
