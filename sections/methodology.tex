...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{clx_mocks.pdf}
\includegraphics[width=0.8\textwidth]{nbar_mocks.pdf}
\caption{Top: cross spectrum. Bottom:  mean density contrast.}\label{fig:clxmock}
\end{figure*}
...
\caption{Left: Cross power spectrum $\chi^{2}$ diagnostic. Right: Mean density contrast diagnostic. The DR9 value is quoted and the histograms are constructed from 1000 realizations of mocks with $\fnl=0$ and $100$.}
\end{figure*}
