...
\label{sec:method} 
\mc{Ashley: I think somewhere in here (probably near the beginning) you need to describe how the 3 regions are combined, since I think you model their selection function separately and then combine for almost all results shown.}\mr{MR: I mention this at the beginning of 2.1.2 and 4. Do you think I should mention it here too?}
