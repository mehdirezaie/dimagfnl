...
\author[M. Rezaie et al.]{Mehdi Rezaie$^{1}$, Ashley J. Ross$^{2}$, Hee-Jong Seo$^{3,5}$,  Hui Kong$^{2}$,  Anna Porredon$^{2}$,\newauthor
Lado Samushia$^{1}$, Edmond Chaussidon$^{4}$, Alex Krolewski$^{6,7,8}$, Arnaud de Mattia$^{4}$,\newauthor
Santiago Avila$^{8.5}$, Benedict Bahr-Kalus$^{9}$, Jose Bermejo-Climent$^{?}$,\newauthor Florian Beutler$^{10}$, Klaus Honscheid$^{2,11}$, Eva-Maria Mueller$^{14,15}$, Adam Myers$^{13}$,\newauthor
...
$^{8.5}$Institut de  F\'isica d'Altes Energies, The Barcelona Institute of Science and Technology, Campus UAB, 08193 Bellaterra (Barcelona), Spain\\
...
$^{13}$Department of Physics and Astronomy, University of Wyoming, Laramie, WY 82071, USA \\
