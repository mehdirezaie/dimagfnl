...
\begin{table*}
    \caption{\mr{The calibrated best-fitting, marginalized mean, and marginalized $68\%$ ($95\%$) confidence estimates for $\fnl$ using the non-linear three maps method and various values of $p$ and $s$. In each case, one hyper-parameter is fixed to its fiducial value (e.g., $p=1$ and $s=0.945$) while changing the other.}}
    \label{tab:dr9ps}
   \centerline{%     
...
%DESI                     & Nonlinear Three Maps+$f_{\rm NL}=76.9$ Cov& $    30$& $    31$& $    18<\fnl<    44$& $     7<\fnl<    59$ &   32.8\\
%\hline
