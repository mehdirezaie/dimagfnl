...
\caption{\mr{Best fitting estimates and $68\%$ ($95\%$) error on $\fnl$ from the DESI DR9 LRG sample with the non-linear three maps cleaning approach. The fiducial values are marked by stars. The constraints are stable against different values of $s$, but exhibit visible sensitivity to $p$.}}\label{fig:fnl_magbias}
\end{figure}
