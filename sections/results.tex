...
All $\fnl$ constraints presented here are calibrated for the effect of over-correction using the lognormal simulations. Table \ref{tab:dr9methodcalib} describes the best-fitting and marginalized mean estimates of $\fnl$ from fitting the power spectrum of the DESI LRG targets before and after cleaning with the non-linear approach given various combinations for the imaging systematic maps. Figure \ref{fig:mcmc_dr9} shows the marginalized probability distribution for $\fnl$ in the top panel, and the $68\%$ and $95\%$ probability contours for the linear bias parameter and $\fnl$ in the bottom panel, from our sample before and after applying various corrections for imaging systematics. Overall, we find the maximum likelihood estimates to be consistent among the various cleaning methods. We obtain \mr{$33 (21) < \fnl < 61(76)$} at $68\%(95\%)$ confidence with \mr{$\chi^{2}=33.9$} for \textit{non-linear three maps} with $34$ degrees of freedom. Accounted for over-correction, we obtain \mr{$33(19) < \fnl < 62(78)$ with $\chi^{2}=34.4$ using the \textit{non-linear four maps} method which includes the additional stellar density map}. With or without stellar density, the confidence intervals are consistent with each other and significantly off from zero PNG; specifically, the probability that $\fnl$ is greater than zero, $P(\fnl >0)=99.9$ per cent. \mr{We also explore the sensitivity of the $\fnl$ posterior for the nonlinear three maps method while varying the value of $p$ in the range of $0.55$ to $1.6$ and $s$ in the range of $0.75$ to $1.25$. Our findings are illustrated in Figure \ref{fig:fnl_magbias} and summarized in Table \ref{tab:dr9ps}. We find that the precise value of $s$ has a negligible impact on the characteristics of the $\fnl$ posterior distribution (as shown in the bottom panel, Figure \ref{fig:fnl_magbias}). However, the parameter $p$ exhibits a more substantial influence on $\fnl$, such that the best-fitting estimate of $\fnl$ and the associated uncertainty both increase as a function of $p$ and the significance of $\fnl>0$ varies from $3.8\sigma$ to $2.6\sigma$ (as shown in the top panel, Figure \ref{fig:fnl_magbias}).}

We also apply a more aggressive systematics treatment that includes regression using the nonlinear approach against the full set of imaging maps we identified, nonlinear nine maps, and find that \mr{zero $\fnl$ is recovered, as regressing against more maps has diminished the constraining power of the dataset. Specifically,} our maximum
likelihood value changes \mout{only slightly} to \mr{$\fnl \sim 34$ with $\chi^{2}=39.5$}, \mout{but} \mr{and} the uncertainty on $\fnl$ increases \mr{by more than a factor of two, $-10(-39)<\fnl<58 (84)$,} due
...
\caption{\mr{Best fitting estimates of $\fnl$ and associated $68\%$ ($95\%$) error from the DESI LRG targets with the non-linear three maps cleaning approach while using different values of $p$ or $s$. The fiducial case ($p=1$ and $s=0.945$) is represented by star. The constraints are stable against different values of $s$, but exhibit visible sensitivity to $p$.}}\label{fig:fnl_magbias}
\end{figure}

\begin{table*}
    \caption{\mr{The calibrated best-fitting and marginalized mean estimates for $\fnl$ using the non-linear three maps method and various values of $p$ and $s$. In each case we fix one hyper-parameter to its fiducial value (e.g., $p=1$ and $s=0.945$) while changing the other.}}
    \label{tab:dr9ps}
   \centerline{%     
...
\hline
$p=$ 0.55                                    & $    36$& $    37$& $    28<\fnl<    47$& $    19<\fnl<    57$ &   33.9\\
0.7                                     & $    38$& $    40$& $    29<\fnl<    50$& $    20<\fnl<    62$ &   33.9\\
0.9                                     & $    43$& $    44$& $    32<\fnl<    57$& $    21<\fnl<    71$ &   33.9\\
1.0                                     & $    46$& $    47$& $    33<\fnl<    61$& $    21<\fnl<    76$ &   33.9\\
1.2                                     & $    54$& $    56$& $    38<\fnl<    73$& $    23<\fnl<    92$ &   33.9\\
1.4                                     & $    66$& $    70$& $    47<\fnl<    93$& $    26<\fnl<   119$ &   33.9\\
1.6                                     & $    91$& $    96$& $    61<\fnl<   130$& $    32<\fnl<   171$ &   33.9\\
\hline
$s=$ 0.75                                    & $    46$& $    49$& $    35<\fnl<    62$& $    23<\fnl<    77$ &   34.1\\
0.80                                    & $    46$& $    48$& $    34<\fnl<    62$& $    23<\fnl<    77$ &   34.1\\
0.85                                    & $    46$& $    48$& $    34<\fnl<    62$& $    23<\fnl<    77$ &   34.0\\
0.90                                    & $    46$& $    48$& $    34<\fnl<    61$& $    22<\fnl<    76$ &   34.0\\
0.945                                   & $    46$& $    47$& $    33<\fnl<    61$& $    21<\fnl<    76$ &   33.9\\
1.00                                    & $    46$& $    47$& $    33<\fnl<    61$& $    21<\fnl<    77$ &   33.9\\
...
\item \textbf{Linear methods}: Even though the linear three maps approach shows significant remaining systematics (Figure \ref{fig:chi2test} and Table \ref{tab:chi2test}), we obtain identical constraints from \textit{linear eight maps} and \textit{linear three maps}, respectively, \mr{$24(14)<\fnl<49(63)$ and $25(14)<\fnl<50(64)$} at $68\%(95\%)$ confidence. \mr{For the linear treatment methods, the probability of $\fnl$ being greater than zero is remarkably high at $99.9$ per cent. Any attempt to account for the over-correction would elevate this probability. This overestimation of $\fnl$ in the data when using the linear methods can be attributed to an increase in systematic contamination.}
