...
to the aggressive treatment removing large-scale clustering information. \mr{This is the only approach that yield results consistent with zero $\fnl$, in which using more maps have diminished the constraining power of the dataset.} For comparison, we obtain \mr{$102(86) < \fnl < 140(161)$} at $68\% (95\%)$ confidence with \mr{$\chi^{2}=45.1$} for the \textit{no weight} case.
