...
\caption{\mr{The best-fitting estimates of $\fnl$ and their corresponding $68\%$ ($95\%$) errors from the DESI LRG targets using the non-linear nine maps approach under various values of $p$ or $s$. The star symbol represents the fiducial analysis, where we fix $p=1$ and $s=0.945$.}}\label{fig:fnl_magbias}
\end{figure}
